        ...
        <div className="stripe-modal-content">
          ...
          <div className="stripe-modal-header">
            ...
            <p className="stripe-subtitle">
              Your Stripe account is fully connected. You can receive payments for your work.
            </p>
          </div>
    ...
    <div className="stripe-connect-modal">
      ...
      <div className="stripe-modal-content">
        ...
        <div className="stripe-modal-header">
          ...
          <h2>Set Up Payment Account</h2>
          <p className="stripe-subtitle">
            {isApprovedBid
              ? "Your bid has been approved! Complete your payment setup to receive payments for this job."
              : "Connect your Stripe account to receive payments directly to your bank account when you complete jobs."
            }
          </p>
        </div>
        ...
        <p className="stripe-footer-note">
          Takes about 5 minutes. You can skip and set this up later from your profile.
        </p>
