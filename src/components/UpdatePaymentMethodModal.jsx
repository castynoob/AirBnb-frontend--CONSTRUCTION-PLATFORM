    ...
    <div className="sp-overlay" onClick={onClose}>
      <div className="sp-success-modal sp-update-success" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="sp-success-left">
          ...
          <h2 className="sp-success-title">Payment Method Updated!</h2>
        ...
        <div className="sp-success-right">
          <h3 className="sp-benefits-title">What happens next</h3>
          ...
          <div className="sp-success-benefits">
            <div className="sp-benefit-item">
              ...
              <div className="sp-benefit-content">
                <strong>New Card Active</strong>
                <span>Future payments will use your new card</span>
              </div>
            </div>
            ...
            <div className="sp-benefit-item">
              ...
              <div className="sp-benefit-content">
                ...
                <span>If you had a failed payment, we'll retry it automatically</span>
              </div>
            </div>
            ...
            <div className="sp-benefit-item">
              ...
              <div className="sp-benefit-content">
                ...
                <span>Your access has been fully restored</span>
              </div>
            </div>
          </div>
    ...
    <div className="sp-overlay" onClick={onClose}>
      <div className="sp-modal sp-single-column" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="sp-update-header">
          ...
          <h3 className="sp-right-title">Update Payment Method</h3>
          <p className="sp-right-subtitle">Enter your new card details below</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="sp-form">
          ...
          <p className="sp-card-note">
            Your new card will be used for all future subscription payments.
          </p>
        </form>
