...
const translations = {
  en: {
    ...
    addWorkModal: {
      ...
      downloadTemplateHint: "New here? Fill this template in Excel, then upload it above.",
      templateDlFailed: "Couldn't download the template.",
    ...
    editJobModal: {
      ...
      // Images
      imagesLabel: 'Photos',
      imagesHint: '(add, remove — max 5MB each)',
      imagesLoading: 'Loading photos…',
      addImage: 'Add photo',
      removeImage: 'Remove',
      imageWorking: 'Working…',
      imageTooBig: 'Each image must be 5MB or smaller.',
      imageUploaded: '{{count}} image(s) added.',
      imageUploadFailed: "Couldn't upload images.",
      imageDeleteConfirm: 'Remove this image?',
      imageDeleted: 'Image removed.',
      imageDeleteFailed: "Couldn't remove image.",
    },
    ...
    residents: {
      ...
      bulkModalTitle: 'Bulk import residents',
      bulkModalSubtitle: 'Upload a spreadsheet of residents to invite them all at once.',
      entityLabel: 'residents',
    },

    // Bulk-import modal — reusable for any entity (residents, properties, unions…)
    bulkImport: {
      eyebrow: 'Bulk import',
      defaultTitle: 'Import from spreadsheet',
      dzTitle: 'Upload file here',
      dzSub: 'Excel (.xlsx, .xls) or CSV',
      browse: 'Browse',
      dlTemplate: 'Download template',
      helper: 'Download the template, fill in your {{entity}}, and upload it back here. Each template includes a Guide sheet explaining every field.',
      entityGeneric: 'rows',
      cancel: 'Cancel',
      import: 'Import',
      uploading: 'Importing…',
      ...
      errBadExt: 'Only .xlsx, .xls, or .csv files are supported.',
      dlFailed: "Couldn't download the template.",
      ...
      errored: 'Errored',
      row: 'Row',
      reportHelper: 'Fix any errored rows in your file and re-import — already-created rows will be skipped automatically.',
    },
  ...
  fr: {
    ...
    addWorkModal: {
      ...
      downloadTemplateHint: 'Nouveau ici? Remplissez ce modèle dans Excel, puis téléversez-le ci-dessus.',
      templateDlFailed: 'Impossible de télécharger le modèle.',
      selectExcelFile: 'Choisir un fichier',
    ...
    editJobModal: {
      ...
      // Images
      imagesLabel: 'Photos',
      imagesHint: '(ajouter, retirer — max 5 Mo chacune)',
      imagesLoading: 'Chargement des photos…',
      addImage: 'Ajouter une photo',
      removeImage: 'Retirer',
      imageWorking: 'En cours…',
      imageTooBig: 'Chaque image doit faire 5 Mo ou moins.',
      imageUploaded: '{{count}} image(s) ajoutée(s).',
      imageUploadFailed: 'Impossible de téléverser les images.',
      imageDeleteConfirm: 'Retirer cette image?',
      imageDeleted: 'Image retirée.',
      imageDeleteFailed: 'Impossible de retirer l\'image.',
    },
    ...
    residents: {
      ...
      networkError: 'Erreur réseau.',
      // Import en lot
      bulkImportBtn: 'Import en lot',
      bulkModalTitle: 'Import en lot de résidents',
      bulkModalSubtitle: 'Téléversez un fichier de résidents pour les inviter tous d\'un coup.',
      entityLabel: 'résidents',
    },

    // Modale d'import en lot — réutilisable pour toute entité (résidents, propriétés, unions…)
    bulkImport: {
      eyebrow: 'Import en lot',
      defaultTitle: 'Importer depuis un fichier',
      dzTitle: 'Déposez le fichier ici',
      dzSub: 'Excel (.xlsx, .xls) ou CSV',
      browse: 'Parcourir',
      dlTemplate: 'Télécharger le modèle',
      helper: 'Téléchargez le modèle, remplissez vos {{entity}}, puis téléversez-le ici. Chaque modèle contient une feuille Guide décrivant chaque champ.',
      entityGeneric: 'lignes',
      cancel: 'Annuler',
      import: 'Importer',
      uploading: 'Importation…',
      importAnother: 'Importer un autre fichier',
      done: 'Terminé',
      errBadExt: 'Seuls les fichiers .xlsx, .xls ou .csv sont pris en charge.',
      dlFailed: 'Impossible de télécharger le modèle.',
      ...
      errored: 'En erreur',
      row: 'Ligne',
      reportHelper: 'Corrigez les lignes en erreur dans votre fichier puis réimportez — les lignes déjà créées seront ignorées automatiquement.',
    },
